...
> - Open **App.tsx** → replace `auth0ClientId` and `authorizationEndpoint` with your respectives **Auth0 App Settings** (to grab this infos go to Expo site, create an acouunt and a App there).
